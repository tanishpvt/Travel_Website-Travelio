...
var tax = (hotels[hotelId].price * 18 / 100);
var total = hotels[hotelId].price + tax;
...
$("#booking_details").html(`<div class="text-start">
                                ...
                                <a href="./Resort-review.html?hotel=${hotelId}" class="btn btn-yellow px-5 py-2 main-btn">Book This Now</a>
                            </div>
                            <div class="price-section">
                                <p><span>Per night </span>
                                    <br>
                                <h3>₹ ${hotels[hotelId].price}</h3><span>+ ₹ ${tax} taxes & fees</span></p>
                            </div>`)
